(function () {
  const specs = {
    ...
    truffle_thunder:{name:'松露雷將',passive:'雷鏈麻痺：攻擊有 10% 機率連鎖，並短暫麻痺命中敵人',skill1:'磁雷牽引',skill1Cost:30,skill1Cooldown:13,skill1Desc:'在角色前方左右放置 2 顆磁極雷球，形成持續 8 秒的電流通道；通道每 0.5 秒造成 14 傷害，一般敵人減速 25%，首領減速 10%。',skill2:'雷域推進',skill2Cost:70,skill2Cooldown:23,skill2Desc:'生成直徑 120、向上緩慢推進的雷電立場 6 秒；每 0.5 秒造成 20 傷害。'},
