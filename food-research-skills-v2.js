(function () {
  const specs = {
    ...
    peach_divine:{passive:'仙桃庇佑：兩名非操控且存活的夥伴每秒回復 1% 最大 HP；每場戰鬥只讓隊伍中首次死亡的 1 名角色以 30% HP 復活',skill1:'仙人模式',skill1Cost:45,skill1Cooldown:14,skill1Desc:'強化 6 秒，每 0.5 秒向前發射 1 道貫穿仙氣，共 12 道，每道 25 傷害。',skill2:'蟠桃回天',skill2Cost:100,skill2Cooldown:24,skill2Desc:'回復最大 HP 的 60%、解除異常、清除一般子彈，並無敵 3 秒。'},
