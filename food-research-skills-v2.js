(function () {
  const specs = {
    ...
    dragonfruit_emperor:{passive:'灼燒光環：185 範圍持續灼燒，攻擊灼燒敵人 +20%',skill1:'雙翼龍焰',skill1Cost:38,skill1Cooldown:14,skill1Desc:'向角色上方來回噴射寬 70 火焰 4.5 秒；每 0.5 秒造成 30 傷害並附加灼燒，同一目標每 0.5 秒最多受傷一次。',skill2:'龍隕雙星',skill2Cost:75,skill2Cooldown:25,skill2Desc:'間隔 2 秒砸下 2 顆直徑約畫面 1/3 的龍隕石；預警 0.7 秒，中心造成 90、外圍造成 100 傷害並灼燒；一般敵人暈眩 1.5 秒，首領暈眩 1 秒。'},
