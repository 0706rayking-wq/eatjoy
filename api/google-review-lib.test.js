...
assert.match(resolveReviewUrl('https://share.google/tHH2TSFPQhsFBcnuL'), /^https:\/\/www\.google\.com\/search\?/);
assert.equal(resolveReviewUrl('https://www.google.com/search?q=test'), 'https://www.google.com/search?q=test');
assert.match(resolveReviewUrl('not-a-url'), /^https:\/\/www\.google\.com\/search\?/);
