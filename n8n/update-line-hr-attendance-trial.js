...
comparisonNode.retryOnFail = true;
comparisonNode.maxTries = 3;
comparisonNode.waitBetweenTries = 5000;
comparisonNode.onError = 'continueRegularOutput';
comparisonNode.parameters.options = { ...(comparisonNode.parameters.options || {}), timeout: 290000 };
