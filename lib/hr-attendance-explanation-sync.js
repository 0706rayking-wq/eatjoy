      ...
      try {
        ...
        await page.waitForFunction(({ employeeNumber, date }) => {
          ...
          return rows.some((candidate) => {
            ...
            const button = candidate.querySelector('[data-th="修改"] #modify, [data-th="修改"] .fa-pen');
            return number === employeeNumber && rowDate.includes(date) && Boolean(button);
          });
        }, { timeout: 25000 }, record);
...
module.exports._test = { normalizeRecords, scheduleDepartment, weekIndexForDate };
